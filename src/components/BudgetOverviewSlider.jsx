...
//   const { income, budget, totalExpenses } = useBudget()
...
//           },
//         });
//         console.log("monthly expenses",response)
...
//   const { id, createdAt } = decodedToken;
...
//   const startMonth = createdDate.getMonth(); // 0-indexed (January = 0)
//   const startYear = createdDate.getFullYear();
//   const endMonth = currentDate.getMonth();
//   const endYear = currentDate.getFullYear();

//   // Calculate months between createdAt and currentDate
//   const monthsBetween = [];
//   let year = startYear;
...
//     month += 1;
//     if (month > 11) { // Wrap around to January
//       month = 0;
//       year += 1;
//     }
//   }

//   console.log('Months:', monthsBetween);

//   // Mock data for previous months - in a real app, this would come from an API
//   const getMonthData = (monthIndex) => {
//     const baseIncome = income;
//     const baseBudget = budget;
//     const baseExpenses = totalExpenses;

//     // Simulate slight variations for different months
//     const variation = Math.sin(monthIndex) * 0.1 + 1;
//     return {
//       income: baseIncome * variation,
//       budget: baseBudget,
//       expenses: baseExpenses * variation,
//       savings: (baseIncome * variation) - (baseExpenses * variation)
//     }
//   }
...
//       if (direction === 'next') {
//         return prev === monthsBetween.length - 1 ? 0 : prev + 1;
//       }
//       return prev === 0 ? monthsBetween.length - 1 : prev - 1;
//     });
//   }
...
//         <h2 className="text-xl font-semibold">{monthsBetween[currentMonthIndex]}</h2>
...
//           <p className="text-xl font-semibold">${currentMonthData.income.toFixed(2)}</p>
//         </div>
//         <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
//           <p className="text-sm text-gray-500 dark:text-gray-400">Budget</p>
//           <p className="text-xl font-semibold">${currentMonthData.budget.toFixed(2)}</p>
//         </div>
//         <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
//           <p className="text-sm text-gray-500 dark:text-gray-400">Expenses</p>
//           <p className="text-xl font-semibold">${currentMonthData.expenses.toFixed(2)}</p>
//         </div>
//         <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
//           <p className="text-sm text-gray-500 dark:text-gray-400">Savings</p>
//           <p className="text-xl font-semibold">${currentMonthData.savings.toFixed(2)}</p>
//         </div>
//       </div>
...
//             <span>
//               {((currentMonthData.expenses / currentMonthData.budget) * 100).toFixed(1)}%
//             </span>
//           </div>
